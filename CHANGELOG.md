...
- **package.json**: Enable install scripts for `re2` and `unrs-resolver` via `allowScripts` to ensure their native binaries are built/downloaded during installation.

### ⬆️ Dependencies

- Bump `brace-expansion` and `js-yaml` to patch CVE-2026-59870 (#61)
- Bump `dropbox` from 10.37.1 to 10.44.0 (#57)
- Bump `re2` from 1.26.0 to 1.26.1 (#57)
- Bump `undici` from 6.27.0 to 6.28.0 (#58)

### ⚙️ Continuous Integration

- Drop Node 20.x and add Node 26.x to CI test matrix (#60)
